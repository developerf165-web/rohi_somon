...
import SelectProductModal from '@/features/create-arrival/ui/SelectProductModal.vue';
import { Trash2, Package2 } from 'lucide-vue-next';
import type { ExpenseItem } from '@/entities/Expense';
...
const updateItemTotal = (item: ExpenseItem) => {
